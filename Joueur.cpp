...
Joueur::Joueur(std::string nom, std::string type, int vitesse, int force, float posX, float posY) : nom(nom), type(type), vitesse(vitesse), force(force), position(posX, posY){}
